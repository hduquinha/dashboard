                  ...
                  <td className="px-3 py-3 text-center text-sm">
                    {inscricao.presencaValidada ? (
                      inscricao.presencaAprovada ? (
                        <span className="inline-flex items-center gap-1 rounded-full bg-emerald-100 px-2 py-0.5 text-[10px] font-semibold text-emerald-700" title="Presente e aprovado">
                        ...
                        <span className="inline-flex items-center gap-1 rounded-full bg-amber-100 px-2 py-0.5 text-[10px] font-semibold text-amber-700" title="Presente mas não completou requisitos">
                          <svg className="h-3 w-3" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>

...
export const NAV_LINKS: NavLink[] = [
  ...
  {
    key: "tarefas-auditoria",
    href: "/tarefas/auditoria",
    label: "Auditoria de Tarefas",
    description: "Histórico de mudanças nos cards e quadros",
    icon: "🧾",
    group: "secondary",
    brand: "instituto-up",
  },
  ...
  },
  {
    key: "documentos",
    href: "/documentos",
    label: "Documentos e PDFs",
    description: "Modelos prontos para configurar e imprimir",
    icon: "📄",
    group: "primary",
    brand: "vozup",
  },
